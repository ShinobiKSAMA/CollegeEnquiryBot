...
class Kernel:
    ...
    def __init__(self):
        ...
        self.setBotPredicate("master","Aditya Mhatre")
        self.setBotPredicate("birthplace","Panvel")
        self.setBotPredicate("location","Panvel")
    ...
    def bootstrap(self, brainFile = None, learnFiles = [], commands = [],
        ...
        if self._verboseMode:
            pass#print( "Kernel bootstrap completed in %.2f seconds" % (verCheck() - start) )
    ...
    def saveBrain(self, filename):
        ...
        if self._verboseMode:
            print( "done (%.2f seconds)" % (verCheck() - start) )
    ...
    def learn(self, filename):
        ...
        for f in glob.glob(filename):
            ...
            if self._verboseMode:
                pass#print( "done (%.2f seconds)" % (verCheck() - start) ) #suppressing the output
